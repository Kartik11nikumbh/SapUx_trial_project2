...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "demo/list/emplist/test/integration/FirstJourney",
    "demo/list/emplist/test/integration/EmployeeDetailListJourney",
    "demo/list/emplist/test/integration/EmployeeDetailObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
